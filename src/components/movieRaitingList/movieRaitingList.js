...
export default class MovieRaitingList extends Component {
  state = {
    movieId: null,
  }
  ...
  render() {
    const { ratingData, updateRaitingMovies, guestSessionId, genre } = this.props
